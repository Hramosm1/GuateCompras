...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        public static void DescargarInfo(int idd)
        {
            try
            {
                if (hayInternet())
                {
                    ...
                    for (int x = 0; x < intervalo; x++)
                    {
                        ...
                        HtmlDocument doc = cWeb.Load("https://www.guatecompras.gt/proveedores/consultaDetProvee.aspx?rqp=10&lprv=" + correlativo);
                        ...
                        if (!(error.Contains("La fuente de información no está disponible")))
                        {
                            ...
                            if (doc.DocumentNode.SelectSingleNode("//*[@id='MasterGC_ContentBlockHolder_gvRepresentantesLegales']") != null)
                            {
                                //representante Legal
                                int i = 0;
                                ...
                                //Datos Adicionales
                                if (doc.DocumentNode.SelectSingleNode("//span[@id='MasterGC_ContentBlockHolder_lblNumeroEscrituraConstitucion']") != null)
                                {
                                ...
                                //Domicilio Fiscal
                                if (doc.DocumentNode.SelectSingleNode("//span[@id='MasterGC_ContentBlockHolder_lblDomDepartamento']") != null)
                                {
                                ...
                                //Domicilio Comercial
                                if (doc.DocumentNode.SelectSingleNode("//span[@id='MasterGC_ContentBlockHolder_lblComPagina']") != null)
                                {
                            ...
                            if (doc.DocumentNode.SelectSingleNode("//*[@id='MasterGC_ContentBlockHolder_dbResumen']") != null)
                            {
                                n = 3;
                                try
                                {
                                    ...
                                    foreach (HtmlNode row in doc.DocumentNode.Descendants("table").FirstOrDefault(_ => _.Id.Equals("MasterGC_ContentBlockHolder_dbResumen")).Descendants("tr"))
                                    {
                                        ...
                                        if (doc.DocumentNode.SelectSingleNode("//span[@id='MasterGC_ContentBlockHolder_dbResumen_ctl0" + n + "_Anio']") != null)
                                        {
                            ...
                            if (doc.DocumentNode.SelectSingleNode("//*[@id='MasterGC_ContentBlockHolder_gvInconformidades']") != null)
                            {
                                // INCONFORMIDADES     
                                n = 1;
                                try
                                ...
                                {
                                    Console.WriteLine("Error en las inconformidades " + ex.Message);
                                }

                            }


                            if (doc.DocumentNode.SelectSingleNode("//*[@id='MasterGC_ContentBlockHolder_Grd_Titulos_ctl02_GV_Mensajes']") != null)
                            {
                                // PROCESOS DE COMPRA
                                n = 1;
                                ...
                                {
                                    Console.WriteLine("Error en los procesos de compras "+ ex.Message);
                                }

                            }


                            if (doc.DocumentNode.SelectSingleNode("//*[@id='MasterGC_ContentBlockHolder_dgResultado']") != null)
                            {
                                // CONTRATO ABIERTO
                                n = 3;
                                try
            ...
            {
                Console.WriteLine("Encontro Error, intentara reestablecer" + ex.StackTrace);
                DescargarInfo(actualid);
            }
